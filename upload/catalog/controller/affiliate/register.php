...
class ControllerAffiliateRegister extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('affiliate/register', '', true)
		);
		...
		$data['text_account_already'] = sprintf($this->language->get('text_account_already'), $this->url->ssl('affiliate/login', '', true));
		...
		$data['action'] = $this->url->ssl('affiliate/register', '', true);
		...
		if ($this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->ssl('information/information/agree', 'information_id=' . $this->config->get('config_affiliate_id'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
