...
class ControllerBlogLatest extends Controller { 	
	public function index() { 
		...
		$data['header'] = $this->load->controller('common/header');
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/blog/latest')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/blog/latest', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/blog/latest', $data));
			}
	}
}
?>