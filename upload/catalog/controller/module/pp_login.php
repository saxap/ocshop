...
class ControllerModulePPLogin extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			...
			$data['return_url'] = $this->url->ssl('module/pp_login/login', '', true);
	...
	public function login() {
		...
		if ($this->customer->isLogged()) {
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->ssl('account/account', '', true) . '"; window.close();</script>';
		}
		...
		if (!isset($this->request->get['code'])) {
			...
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->ssl('account/login', '', true) . '"; window.close();</script>';
		} else {
