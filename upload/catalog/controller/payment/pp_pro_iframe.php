...
class ControllerPaymentPPProIframe extends Controller {
	...
	private function constructButtonData($order_info) {
		...
		$s_data['L_BUTTONVAR20'] = 'notify_url=' . $this->url->ssl('payment/pp_pro_iframe/notify', '', true);
		$s_data['L_BUTTONVAR21'] = 'cancel_return=' . $this->url->ssl('checkout/checkout', '', true);
		...
		$s_data['L_BUTTONVAR56'] = 'return=' . $this->url->ssl('checkout/success', '', true);
