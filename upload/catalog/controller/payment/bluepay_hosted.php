...
class ControllerPaymentBluePayHosted extends Controller {
	public function index() {
		...
		$data['APPROVED_URL'] = $this->url->ssl('payment/bluepay_hosted/callback', '', true);
		$data['DECLINED_URL'] = $this->url->ssl('payment/bluepay_hosted/callback', '', true);
		$data['MISSING_URL'] = $this->url->ssl('payment/bluepay_hosted/callback', '', true);
		$data['REDIRECT_URL'] = $this->url->ssl('payment/bluepay_hosted/callback', '', true);
