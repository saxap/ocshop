...
class ControllerAccountDownload extends Controller {
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->ssl('account/download', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('account/download', '', true)
		);
		...
		foreach ($results as $result) {
			if (file_exists(DIR_DOWNLOAD . $result['filename'])) {
				...
				$data['downloads'][] = array(
					...
					'href'       => $this->url->ssl('account/download/download', 'download_id=' . $result['download_id'], true)
				);
			}
		}
		...
		$pagination->url = $this->url->ssl('account/download', 'page={page}', true);
	...
	public function download() {
		...
		if ($download_info) {
			...
			$this->response->redirect($this->url->ssl('account/download', '', true));
		}
	}
}