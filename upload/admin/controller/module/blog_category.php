...
class ControllerModuleBlogCategory extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('module/blog_category', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->ssl('module/blog_category', 'token=' . $this->session->data['token'], true);
