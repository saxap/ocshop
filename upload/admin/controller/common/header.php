...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			// News Added Menu
			$data['new_category'] = $this->url->ssl('catalog/category/add', 'token=' . $this->session->data['token'], true);
			$data['new_customer'] = $this->url->ssl('user/user/add', 'token=' . $this->session->data['token'], true);
			$data['new_download'] = $this->url->ssl('catalog/download/add', 'token=' . $this->session->data['token'], true);
			$data['new_manufacturer'] = $this->url->ssl('catalog/manufacturer/add', 'token=' . $this->session->data['token'], true);
			$data['new_product'] = $this->url->ssl('catalog/product/add', 'token=' . $this->session->data['token'], true);
