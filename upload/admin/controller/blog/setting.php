...
class ControllerBlogSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->ssl('blog/setting', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('blog/setting', 'token=' . $this->session->data['token'], true)
		);
		...
		$data['action'] = $this->url->ssl('blog/setting', 'token=' . $this->session->data['token'], true);
