...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$data['enabled'] = $this->url->ssl('catalog/review/enable', 'token=' . $this->session->data['token'] . $url, true);
        $data['disabled'] = $this->url->ssl('catalog/review/disable', 'token=' . $this->session->data['token'] . $url, true);
